...
- Automatic model policy is NO_DEEPSEEK and fail-closed. Provider namespaces, worker env, caller args and self-authored refs do not prove cost/privacy authority.

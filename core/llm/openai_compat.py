...
class OpenAICompatClient(LLMClient):
    ...
    def __init__(self, api_key: str, model: str, base_url: str = "https://api.openai.com/v1", timeout: int = 60) -> None:
        ...
        **kwargs: Any,
        ...
        if _is_local_ollama_base_url(self.base_url):
            ...
            if "response_format" in payload:
                payload["reasoning_effort"] = str(kwargs.get("reasoning_effort") or "none")
...
class DeepSeekClient(OpenAICompatClient):
    ...
    def __init__(self, api_key: str, model: str = "deepseek-chat", base_url: str = "https://api.deepseek.com/v1", timeout: int = 60) -> None:
        super().__init__(api_key=api_key, model=model, base_url=base_url, timeout=timeout)
...
class OllamaCompatClient(OpenAICompatClient):
    ...
    def __init__(self, model: str, base_url: str = "http://127.0.0.1:11434/v1", timeout: int = 60) -> None:
...
class GroqClient(OpenAICompatClient):
    ...
    def __init__(self, api_key: str, model: str = "llama-3.3-70b-versatile", base_url: str = "https://api.groq.com/openai/v1", timeout: int = 60) -> None:
        super().__init__(api_key=api_key, model=model, base_url=base_url, timeout=timeout)
...
class OpenAIClient(OpenAICompatClient):
    ...
    def __init__(self, api_key: str, model: str = "gpt-4o-mini", base_url: str = "https://api.openai.com/v1", timeout: int = 60) -> None:
        super().__init__(api_key=api_key, model=model, base_url=base_url, timeout=timeout)

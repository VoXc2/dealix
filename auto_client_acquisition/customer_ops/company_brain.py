...
_ALWAYS_BLOCKED_CHANNELS: tuple[str, ...] = (
    "cold_whatsapp",  # blocked — forbidden direct-marketing channel
...
async def build_company_brain(  # noqa: C901 — long but flat
    ...
    # 5. Always-blocked floor — forbidden channel must remain in blocked list regardless of company config
    if "cold_whatsapp" not in (t.blocked_channels or []):  # blocked floor

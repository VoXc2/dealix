      ...
      <div className="max-w-5xl mx-auto px-6 py-12">
        ...
        <div className="grid gap-6 md:grid-cols-2 mt-8">
          <div className="rounded-xl border border-white/10 bg-white/5 p-6">
            <h3 className="font-bold text-gold-400">{isAr ? "التشخيص" : "Diagnostic"}</h3>
            ...
            <Link href={`/${locale}/dealix-diagnostic`} className="inline-block mt-4 bg-gold-500 text-navy-900 px-4 py-2 rounded-lg font-bold">→</Link>
          </div>
          <div className="rounded-xl border border-white/10 bg-white/5 p-6">
          ...
          <div className="rounded-xl border border-white/10 bg-white/5 p-6">
            <h3 className="font-bold text-gold-400">{isAr ? "التسجيل" : "Register"}</h3>
            ...
            <Link href={`/${locale}/onboarding`} className="inline-block mt-4 bg-gold-500 text-navy-900 px-4 py-2 rounded-lg font-bold">→</Link>
          </div>
        ...
        <div className="mt-8 rounded-xl border border-gold-500/20 bg-gold-500/10 p-6">
          <h3 className="font-bold text-gold-400">{isAr ? "توضيح شامل" : "Comprehensive Explanation"}</h3>

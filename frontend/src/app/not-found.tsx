...
export default function NotFound() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-6 text-center bg-[#001F3F] text-white">
      <p className="text-sm font-semibold tracking-widest uppercase text-gold-400 mb-3">404 — Not Found</p>
      ...
      <div className="flex flex-wrap gap-3 justify-center">
        <Link href="/ar" className="px-6 py-3 rounded-xl bg-gold-500 text-navy-500 font-bold hover:bg-gold-400 transition-colors">
          الرئيسية — Home
        </Link>

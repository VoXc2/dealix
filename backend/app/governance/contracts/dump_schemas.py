"""
Dump all Dealix governance contract JSON Schemas to
backend/app/governance/contracts/schemas/.

Run: python -m app.governance.contracts.dump_schemas
"""
...
from app.governance.contracts import AuditEntry, DecisionOutput, EventEnvelope, EvidencePack

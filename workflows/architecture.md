...
trigger -> conditions -> actions -> approvals -> retries -> compensation -> analytics.
...
Inputs: workflow trigger. Outputs: audited workflow run + analytics.

## Position in the operating model

- Risk tier: **high**
- Maturity dimensions advanced: workflow_native, orchestrated

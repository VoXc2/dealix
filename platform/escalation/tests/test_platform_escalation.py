"""Self-verification for the Escalation operating-model system.
...
SYSTEM_DIR = REPO / "platform/escalation"
IMPLEMENTED_BY = ['auto_client_acquisition/approval_center', 'auto_client_acquisition/governance_os/approval_matrix.py']
...
def test_implementing_modules_exist():
    ...
    assert not missing, (
        f"Escalation architecture.md references modules that no longer exist: "

"""Self-verification for the Agent Runtime operating-model system.
...
SYSTEM_DIR = REPO / "platform/agent_runtime"
IMPLEMENTED_BY = ['auto_client_acquisition/agent_os', 'auto_client_acquisition/secure_agent_runtime_os', 'auto_client_acquisition/agentic_operations_os']
...
def test_implementing_modules_exist():
    ...
    assert not missing, (
        f"Agent Runtime architecture.md references modules that no longer exist: "

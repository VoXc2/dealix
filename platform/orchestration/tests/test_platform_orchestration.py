"""Self-verification for the Orchestration operating-model system.
...
SYSTEM_DIR = REPO / "platform/orchestration"
IMPLEMENTED_BY = ['auto_client_acquisition/orchestrator', 'auto_client_acquisition/agentic_operations_os']
...
def test_implementing_modules_exist():
    ...
    assert not missing, (
        f"Orchestration architecture.md references modules that no longer exist: "

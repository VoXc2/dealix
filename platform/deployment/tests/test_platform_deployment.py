"""Self-verification for the Deployment / Infrastructure-as-Code operating-model system.
...
SYSTEM_DIR = REPO / "platform/deployment"
IMPLEMENTED_BY = ['auto_client_acquisition/enterprise_rollout_os', 'scripts/infra', 'Dockerfile', 'docker-compose.yml', '.github']
...
def test_implementing_modules_exist():
    ...
    assert not missing, (
        f"Deployment / Infrastructure-as-Code architecture.md references modules that no longer exist: "

"""Self-verification for the Identity operating-model system.
...
SYSTEM_DIR = REPO / "platform/identity"
...
def test_implementing_modules_exist():
    ...
    assert not missing, (
        f"Identity architecture.md references modules that no longer exist: "

"""Self-verification for the Policy Engine operating-model system.
...
SYSTEM_DIR = REPO / "platform/policy_engine"
IMPLEMENTED_BY = ['auto_client_acquisition/governance_os/policy_registry.py', 'auto_client_acquisition/governance_os/policy_check.py']
...
def test_implementing_modules_exist():
    ...
    assert not missing, (
        f"Policy Engine architecture.md references modules that no longer exist: "

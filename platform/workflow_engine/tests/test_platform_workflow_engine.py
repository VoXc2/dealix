"""Self-verification for the Workflow Engine operating-model system.
...
SYSTEM_DIR = REPO / "platform/workflow_engine"
...
def test_implementing_modules_exist():
    ...
    assert not missing, (
        f"Workflow Engine architecture.md references modules that no longer exist: "

"""Self-verification for the Reranking operating-model system.
...
SYSTEM_DIR = REPO / "platform/reranking"
IMPLEMENTED_BY = ['auto_client_acquisition/intelligence_os', 'auto_client_acquisition/intelligence']
...
def test_implementing_modules_exist():
    ...
    assert not missing, (
        f"Reranking architecture.md references modules that no longer exist: "

"""Self-verification for the Execution Engine operating-model system.
...
SYSTEM_DIR = REPO / "platform/execution_engine"
IMPLEMENTED_BY = ['auto_client_acquisition/execution_os', 'auto_client_acquisition/delivery_factory']
...
def test_implementing_modules_exist():
    ...
    assert not missing, (
        f"Execution Engine architecture.md references modules that no longer exist: "

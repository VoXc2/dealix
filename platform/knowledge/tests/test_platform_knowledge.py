"""Self-verification for the Knowledge operating-model system.
...
SYSTEM_DIR = REPO / "platform/knowledge"
IMPLEMENTED_BY = ['auto_client_acquisition/knowledge_os', 'auto_client_acquisition/company_brain']
...
def test_implementing_modules_exist():
    ...
    assert not missing, (
        f"Knowledge architecture.md references modules that no longer exist: "

"""Self-verification for the Platform Foundation operating-model system.
...
SYSTEM_DIR = REPO / "platform/foundation"
...
def test_implementing_modules_exist():
    ...
    assert not missing, (
        f"Platform Foundation architecture.md references modules that no longer exist: "

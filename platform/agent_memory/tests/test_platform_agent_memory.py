"""Self-verification for the Agent Memory operating-model system.
...
SYSTEM_DIR = REPO / "platform/agent_memory"
...
def test_implementing_modules_exist():
    ...
    assert not missing, (
        f"Agent Memory architecture.md references modules that no longer exist: "

"""Self-verification for the Multi-Tenant Architecture operating-model system.
...
SYSTEM_DIR = REPO / "platform/multi_tenant"
...
def test_implementing_modules_exist():
    ...
    assert not missing, (
        f"Multi-Tenant Architecture architecture.md references modules that no longer exist: "

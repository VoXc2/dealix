"""Self-verification for the Retrieval operating-model system.
...
SYSTEM_DIR = REPO / "platform/retrieval"
IMPLEMENTED_BY = ['auto_client_acquisition/intelligence_os', 'auto_client_acquisition/revenue_memory']
...
def test_implementing_modules_exist():
    ...
    assert not missing, (
        f"Retrieval architecture.md references modules that no longer exist: "

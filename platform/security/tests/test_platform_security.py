"""Self-verification for the Security operating-model system.
...
SYSTEM_DIR = REPO / "platform/security"
IMPLEMENTED_BY = ['auto_client_acquisition/security_privacy', 'auto_client_acquisition/secure_agent_runtime_os', '.gitleaks.toml']
...
def test_implementing_modules_exist():
    ...
    assert not missing, (
        f"Security architecture.md references modules that no longer exist: "

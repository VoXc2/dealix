"""Self-verification for the Observability operating-model system.
...
SYSTEM_DIR = REPO / "platform/observability"
IMPLEMENTED_BY = ['auto_client_acquisition/observability_v10', 'auto_client_acquisition/observability_adapters', 'auto_client_acquisition/auditability_os']
...
def test_implementing_modules_exist():
    ...
    assert not missing, (
        f"Observability architecture.md references modules that no longer exist: "

"""Self-verification for the Approval Engine operating-model system.
...
SYSTEM_DIR = REPO / "platform/approval_engine"
IMPLEMENTED_BY = ['auto_client_acquisition/governance_os/approval_matrix.py', 'auto_client_acquisition/approval_center']
...
def test_implementing_modules_exist():
    ...
    assert not missing, (
        f"Approval Engine architecture.md references modules that no longer exist: "

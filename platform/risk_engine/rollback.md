# Risk Engine — Rollback

## Blast radius

Risk tier **high**. A failure here affects: governable, measurable, enterprise_safe.
...
4. Re-run this system's `tests/` and Phase 5 evals before un-freezing.

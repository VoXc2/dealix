"""Self-verification for the Risk Engine operating-model system.
...
SYSTEM_DIR = REPO / "platform/risk_engine"
IMPLEMENTED_BY = ['auto_client_acquisition/risk_resilience_os', 'auto_client_acquisition/governance_os/runtime_decision.py']
...
def test_implementing_modules_exist():
    ...
    assert not missing, (
        f"Risk Engine architecture.md references modules that no longer exist: "

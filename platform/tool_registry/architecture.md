...
Every tool is declared, permissioned, and guardrailed.
...
- `auto_client_acquisition/agent_os/tool_permissions.py`
- `auto_client_acquisition/tool_guardrail_gateway`

## Contract

Inputs: tool call request. Outputs: guardrail decision + scoped invocation.

## Position in the operating model

- Risk tier: **high**
- Maturity dimensions advanced: agent_ready, governable, enterprise_safe

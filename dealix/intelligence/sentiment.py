...
# Weights in [-1, 1].
_POS_RAW = {
    "ممتاز": 1.0, "ممتازة": 1.0, "رائع": 1.0, "رائعة": 1.0,
    "حلو": 0.8, "حلوة": 0.8, "جيد": 0.7, "جيدة": 0.7, "مناسب": 0.6,
    "شكرا": 0.9, "فخور": 0.9, "عجبني": 0.9, "احسنتم": 0.9, "ابدع": 0.9,
    "اعجبني": 0.9, "زين": 0.7, "كفو": 0.9, "يعطيك": 0.6, "طيب": 0.5,
}
_NEG_RAW = {
    "سيء": -1.0, "سيئة": -1.0, "فاشل": -1.0, "فاشلة": -1.0,
    "ضعيف": -0.9, "زعلان": -0.9, "مخيب": -0.9,
    "مزعج": -0.8, "تافه": -1.0, "رديء": -1.0, "ما عجبني": -0.9, "ما يسوى": -1.0,
    "غلط": -0.6, "مشكله": -0.7, "مشكلة": -0.7, "بطيء": -0.6, "غالي": -0.5,
    "معقد": -0.5,
}

...
INVARIANTS: list[CompanyInvariant] = [
    CompanyInvariant(invariant_id="INV-001", description="exactly five permanent agents", severity=InvariantSeverity.CRITICAL, enforcement="AGENT_TEAM_REGISTRY + audit_agent_team.py --strict", test="tests/test_agent_team_audit.py"),
    CompanyInvariant(invariant_id="INV-002", description="DEEP_WIP <= 3", severity=InvariantSeverity.CRITICAL, enforcement="EconomicCellRegistry.claim_deep_wip_slot + DeepWipEnforcer + tests", test="tests/test_deep_wip_enforcer.py"),

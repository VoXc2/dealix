...
EXTRA = [
    ...
    CapabilityArm(arm_id="arm_35_content_factory", name="Content Factory", name_ar="مصنع المحتوى", purpose="proof→ar/en article + post + FAQ, atomization 1→4, no spam", owner_agent="dealix-content", capabilities=["atomize","distribute"], supported_sectors=["*"], supported_problems=["content_distribution"], health=ArmHealth.ACTIVE, maturity=3),

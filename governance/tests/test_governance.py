"""Self-verification for the Governance operating-model system.
...
def test_implementing_modules_exist():
    ...
    assert not missing, (
        f"Governance architecture.md references modules that no longer exist: "

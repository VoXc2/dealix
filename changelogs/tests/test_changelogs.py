"""Self-verification for the Changelogs operating-model system.
...
def test_implementing_modules_exist():
    ...
    assert not missing, (
        f"Changelogs architecture.md references modules that no longer exist: "

#!/usr/bin/env python3
"""DEALIX_GO_RESOURCE_BROKER — maximum verified value per included Go unit.
...
TASK_ROUTES: dict[str, str] = {
    "HEALTH_CHECK": "R0_NO_MODEL",
    "SCHEDULER_AUDIT": "R1_DETERMINISTIC",
    "FINGERPRINT": "R1_DETERMINISTIC",
    "CLASSIFICATION": "R2_LOCAL_OLLAMA",
    "EXTRACTION": "R2_LOCAL_OLLAMA",
    "ARABIC": "R3_INCLUDED_LIGHT",
    "CONTENT_DRAFT": "R3_INCLUDED_LIGHT",
    "DIAGNOSTIC_REASONING": "R4_INCLUDED_HIGH",
    "CODE_ENGINEERING": "R4_INCLUDED_HIGH",
    "BUG_FIXING": "R4_INCLUDED_HIGH",
    "TEST_GENERATION": "R4_INCLUDED_HIGH",
    "COMMERCIAL_REASONING": "R4_INCLUDED_HIGH",
    "RESEARCH_SYNTHESIS": "R4_INCLUDED_HIGH",
    "ARCHITECTURE": "R5_STRONG_REASONING",
...
def plan_route(
    ...
    return {
        ...
        "reserve_kept": RESERVED_INCLUDED_JOBS,
        "headroom": UNKNOWN,
    }
...
def daily_envelope(state: dict[str, Any], now: datetime | None = None) -> dict[str, Any]:
    ...
    return {
        "date": today,
        "included_jobs_today": included_today,
        ...
        "headroom_source": "conservative_envelope__exact_go_headroom_not_locally_observable",
    }


def record_job(state: dict[str, Any], task_class: str, route: str, model: str, outcome: str = "planned") -> dict[str, Any]:
    job = {

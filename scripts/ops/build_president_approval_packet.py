    ...
    raw_items = [
        {
            ...
            "why_now": "PR chain #1700-#1704 is locally verified and stacked; main has not absorbed the truth/diagnostic/ops/sector fixes.",
...
def main() -> int:
    ...
    chain = {}
    for number in (1700, 1701, 1702, 1703, 1704):

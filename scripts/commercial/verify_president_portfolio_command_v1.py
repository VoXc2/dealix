...
def main()->int:
    ...
    required=['deep_wip_selection','capability_cells_are_not_opportunities','PRIORITIZATION_HEURISTIC_NOT_PURCHASE_PROBABILITY','SUPPRESSION_BLOCK','ARM_STATE_BLOCKS_ACTIVATION','founder_required_actions','portfolio_enrichment_queue','ARM_MAPPING_REQUIRED','DETERMINISTIC_HYPOTHESIS_NOT_EVIDENCE']

...
const nextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: "/privacy.html", destination: "/legal", permanent: true },
      { source: "/terms.html", destination: "/legal", permanent: true },
      ...
      { source: "/brain", destination: "/products", permanent: true },
      { source: "/company-brain-os", destination: "/products", permanent: true },
      { source: "/products/revenue-command-room-os", destination: "/products", permanent: true },
      { source: "/products/company-brain-os", destination: "/products", permanent: true },
      { source: "/products/whatsapp-inbox-followup-os", destination: "/products", permanent: true },
      { source: "/products/ai-trust-compliance-os", destination: "/products", permanent: true },

...
**ديالكس — تشغيل إيراد وذكاء اصطناعي محكوم.** ديالكس تبيع قرارات إيراد وذكاء اصطناعي محكومة ومدعومة بالأدلة — مصادر واضحة، وموافقات، وأدلة، وقيمة قابلة للقياس — لا روبوتات ولا أتمتة.

> التموضع والاستراتيجية المرجعية: [`docs/strategy/GOVERNED_REVENUE_AI_OPERATIONS.md`](docs/strategy/GOVERNED_REVENUE_AI_OPERATIONS.md). سلم العروض والأسعار (الإصدار 2): [`docs/OFFER_LADDER_AND_PRICING.md`](docs/OFFER_LADDER_AND_PRICING.md).

تعمل المنصة عبر طبقات وكلاء جاهزة للإنتاج:

...
2. Repoint runtime to last known-good `executive_agent` release.
...
|---|---|---|
| T-AGT-EXC-070 | runtime version rollback | prior behavior restored |
| T-AGT-EXC-071 | policy-safe fallback | no approval bypass |
| T-AGT-EXC-072 | KPI stabilization check | metrics return within tolerance |

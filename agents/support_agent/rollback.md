...
2. Repoint runtime to last known-good `support_agent` release.
...
|---|---|---|
| T-AGT-SUP-070 | runtime version rollback | prior behavior restored |
| T-AGT-SUP-071 | policy-safe fallback | no approval bypass |
| T-AGT-SUP-072 | KPI stabilization check | metrics return within tolerance |

"""Self-verification for the Agent Catalog operating-model system.
...
SYSTEM_DIR = REPO / "agents"
IMPLEMENTED_BY = ['auto_client_acquisition/agents', 'auto_client_acquisition/ai_workforce_v10', 'core/agents']
...
def test_implementing_modules_exist():
    ...
    assert not missing, (
        f"Agent Catalog architecture.md references modules that no longer exist: "

...
2. Repoint runtime to last known-good `sales_agent` release.
...
|---|---|---|
| T-AGT-SLS-070 | runtime version rollback | prior behavior restored |
| T-AGT-SLS-071 | policy-safe fallback | no approval bypass |
| T-AGT-SLS-072 | KPI stabilization check | metrics return within tolerance |

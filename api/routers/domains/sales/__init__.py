...
from api.routers import (
    ...
    prospect,
    revenue,
    revenue_ops_dashboard as revenue_ops_dashboard_router,
    revenue_ops_machine as revenue_ops_machine_router,
    revenue_os,
    revenue_pipeline,
...
_ROUTERS = [
    ...
    sales_os.router,
    revenue.router,
    revenue_ops_machine_router.router,
    revenue_ops_dashboard_router.router,
    revenue_os.router,

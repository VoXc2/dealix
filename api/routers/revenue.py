...
NEGOTIATION_TEMPLATES_AR = {
    ...
    "feature_missing": (
        "إذا كانت الميزة غير متاحة الآن، ما نعد بموعد غير مثبت. نوثق الفجوة والـworkaround "
        "الممكن ضمن النطاق المتفق عليه، وأي تطوير لاحق يحتاج قبولاً ونطاقاً واضحين."
    ),
    "timing_objection": (
    ...
    "competitor_comparison": (
        "نقارن Dealix بالبدائل على متطلباتكم المثبتة: العربية/الإنجليزية، التكامل، الحوكمة، "
        "الخصوصية، القنوات ومعايير القبول. ما ندّعي تفوقاً أو توافقاً أو وسيلة دفع بدون "
        "دليل حالي؛ خلّنا نقارن جانب-بجانب على سيناريوكم."
    ),
    "decision_maker_unavailable": (
        "ممتاز. نجهّز لكم مسودة one-pager + خيارات حجز داخلية للمراجعة فقط؛ تجهيز المواد "
        "لا يعني إرسالها أو إنشاء التزام خارجي. أي إرسال أو متابعة خارجية تتم فقط بعد "
        "موافقة محددة على الرسالة والقناة والمستلم."
    ),
}

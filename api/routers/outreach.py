...
def _build_message_template(account: dict[str, Any], score: dict[str, Any]) -> str:
    ...
    if priority == "P0":
        opening = (
            ...
            "Dealix يساعد على تنظيم التعامل مع inbound leads بالعربي ضمن حدود البيانات والموافقات المناسبة للحالة، بدون وعد بزمن استجابة أو ادعاء امتثال شامل. "
        ...
        opening = (
            ...
            "ننظم inbound lead workflow والمتابعة مع موافقات وProof واضحين؛ لا نعد بزمن استجابة أو حجز تلقائي. "

...
from api.routers import institutional_operating_core as institutional_operating_core_router
...
def create_app() -> FastAPI:
    ...
    # Institutional Layer — systems 56-65 dependency verdicts
    app.include_router(institutional_operating_core_router.router)

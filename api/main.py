...
# Wave 16 — Enterprise maturity model (platform self-assessment)
from api.routers import enterprise_maturity as enterprise_maturity_router
...
def create_app() -> FastAPI:
    ...
    # Wave 16 — Enterprise maturity model (platform self-assessment)
    app.include_router(enterprise_maturity_router.router)

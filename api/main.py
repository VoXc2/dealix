...
# Wave 16 — Agentic Enterprise AI Operating Fabric (12-layer index)
from api.routers import agentic_enterprise as agentic_enterprise_router
...
def create_app() -> FastAPI:
    ...
    # Wave 16 — Agentic Enterprise AI Operating Fabric (public 12-layer index)
    app.include_router(agentic_enterprise_router.router)

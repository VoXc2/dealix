# Organizational Memory — Rollback

## Blast radius

Risk tier **medium**. A failure here affects: transformation_ready, continuously_improving.
...
4. Re-run this system's `tests/` and Phase 4 evals before un-freezing.
5. Record the incident in `changelogs/` and `auto_client_acquisition/auditability_os`.

## Approval

Rollback of a **medium**-tier system is authorized by the system owner;

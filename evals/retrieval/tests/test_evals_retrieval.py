"""Self-verification for the Retrieval Evals operating-model system.
...
SYSTEM_DIR = REPO / "evals/retrieval"
...
def test_implementing_modules_exist():
    ...
    assert not missing, (
        f"Retrieval Evals architecture.md references modules that no longer exist: "

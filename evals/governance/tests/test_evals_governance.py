"""Self-verification for the Governance Evals operating-model system.
...
SYSTEM_DIR = REPO / "evals/governance"
...
def test_implementing_modules_exist():
    ...
    assert not missing, (
        f"Governance Evals architecture.md references modules that no longer exist: "

"""Self-verification for the Business Impact Evals operating-model system.
...
SYSTEM_DIR = REPO / "evals/business_impact"
...
def test_implementing_modules_exist():
    ...
    assert not missing, (
        f"Business Impact Evals architecture.md references modules that no longer exist: "

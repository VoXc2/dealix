# Business Impact Evals — Rollback

## Blast radius

Risk tier **medium**. A failure here affects: measurable, continuously_improving.
...
4. Re-run this system's `tests/` and Phase 6 evals before un-freezing.

# Hallucination Evals — Metrics

| KPI | Target | Current |
|-----|--------|---------|
| `hallucination_rate` | _set target_ | _live value_ |
| `groundedness_score` | _set target_ | _live value_ |
| `unsupported_claim_count` | _set target_ | _live value_ |

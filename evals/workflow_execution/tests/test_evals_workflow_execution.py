"""Self-verification for the Workflow Execution Evals operating-model system.
...
SYSTEM_DIR = REPO / "evals/workflow_execution"
...
def test_implementing_modules_exist():
    ...
    assert not missing, (
        f"Workflow Execution Evals architecture.md references modules that no longer exist: "

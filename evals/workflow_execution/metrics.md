# Workflow Execution Evals — Metrics

| KPI | Target | Current |
|-----|--------|---------|
| `workflow_eval_pass_rate` | _set target_ | _live value_ |
| `compensation_correctness` | _set target_ | _live value_ |
| `audit_gap_count` | _set target_ | _live value_ |

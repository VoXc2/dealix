"""Self-verification for the Agent Behavior Evals operating-model system.
...
SYSTEM_DIR = REPO / "evals/agent_behavior"
...
def test_implementing_modules_exist():
    ...
    assert not missing, (
        f"Agent Behavior Evals architecture.md references modules that no longer exist: "

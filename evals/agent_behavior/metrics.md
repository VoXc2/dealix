# Agent Behavior Evals — Metrics

| KPI | Target | Current |
|-----|--------|---------|
| `agent_eval_pass_rate` | _set target_ | _live value_ |
| `boundary_violation_count` | _set target_ | _live value_ |
| `tool_misuse_count` | _set target_ | _live value_ |

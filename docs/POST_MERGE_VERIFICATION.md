...
```bash
python -m compileall api auto_client_acquisition integrations dealix
pytest -q --no-cov
...
API entry: `GET /api/v1/company-growth-beast/status` — see [`docs/COMPANY_GROWTH_BEAST_SERVICE.md`](COMPANY_GROWTH_BEAST_SERVICE.md).

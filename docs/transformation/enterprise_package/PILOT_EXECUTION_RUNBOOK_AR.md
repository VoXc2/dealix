...
هذا الدليل يربط قوالب `docs/transformation/enterprise_package/` بتشغيل حقيقي داخل Dealix مع الإبقاء على سياسة **الموافقة أولًا** و**عدم الإرسال الخارجي التلقائي**. لتكرار البايلوت بعد كل عميل استخدم أيضًا [PILOT_REPEAT_CHECKLIST_AR.md](PILOT_REPEAT_CHECKLIST_AR.md).

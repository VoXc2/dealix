...
> **تحديث الفئة (2026-05-17):** الفئة المعتمدة الآن هي **"الإيراد المُحوكَم وعمليات الذكاء الاصطناعي — Governed Revenue & AI Ops"**. المرجع الأوحد للفئة وسلم العروض والاستراتيجية الكاملة: [GOVERNED_REVENUE_AI_OPS_STRATEGY.md](GOVERNED_REVENUE_AI_OPS_STRATEGY.md). صياغة "Revenue Execution OS" أدناه تبقى كاسم معمارية، لا كاسم الفئة.
...
**الفئة الصحيحة المعتمدة:** `Governed Revenue & AI Ops` — الإيراد المُحوكَم وعمليات الذكاء الاصطناعي: تنفيذ إيرادات مربوط بسياق سعودي، حوكمة وبوابات موافقة، وإثبات. (`Revenue Execution OS` يبقى كاسم معمارية المنتج لا كاسم الفئة — انظر [GOVERNED_REVENUE_AI_OPS_STRATEGY.md](GOVERNED_REVENUE_AI_OPS_STRATEGY.md).)

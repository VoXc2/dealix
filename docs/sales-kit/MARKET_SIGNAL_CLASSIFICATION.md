...
|---|---|---|---|---|
| `replied_interested` | رد بالاهتمام | Reply within 30 min during working hours (the War Room §3 SLA). Request a 20-min qualification call. | رد خلال 30 دقيقة في ساعات العمل (وفق SLA غرفة الحرب §3). اطلب مكالمة تأهيل 20 دقيقة. | War Room §3 |

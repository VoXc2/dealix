...
| "كيف نثبت ROI؟" | التشخيص في 7 أيام يعطي صورة بالأدلة لفجوات الإيراد |
| "غالي للتجربة" | شريحة Starter من التشخيص (4,999 SAR) تعطي وضوح قرار بالأدلة في أسبوع |
...
**السعر المناسب:** التشخيص في 7 أيام (يبدأ من 4,999 SAR) ثم Governed Ops Retainer.
...
**السعر المناسب:** 7-Day Diagnostic → Revenue Intelligence Sprint → Governed Ops Retainer.
...
**السعر المناسب:** 7-Day Diagnostic → Governed Ops Retainer.
...
القرار (Decision)
  ↓ 7-Day Governed Revenue & AI Ops Diagnostic — صورة بالأدلة في 7 أيام
الاحتفاظ (Retention)
  ↓ نتيجة موثقة → Revenue Intelligence Sprint ثم Governed Ops Retainer
الإحالة (Referral)

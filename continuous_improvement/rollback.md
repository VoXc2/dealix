# Continuous Improvement — Rollback

## Blast radius

Risk tier **medium**. A failure here affects: continuously_improving, evolvable.
...
4. Re-run this system's `tests/` and Phase 7 evals before un-freezing.

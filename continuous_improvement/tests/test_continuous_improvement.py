"""Self-verification for the Continuous Improvement operating-model system.
...
SYSTEM_DIR = REPO / "continuous_improvement"
IMPLEMENTED_BY = ['auto_client_acquisition/learning_flywheel', 'auto_client_acquisition/self_growth_os']
...
def test_implementing_modules_exist():
    ...
    assert not missing, (
        f"Continuous Improvement architecture.md references modules that no longer exist: "

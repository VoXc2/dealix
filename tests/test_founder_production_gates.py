"""Founder production gates — unified self-host + GTM + weekly blockers."""

from __future__ import annotations

from dealix.commercial_ops.founder_production_gates import build_founder_production_gates
from dealix.commercial_ops.selfhost_production import probe_trust_layer
...
def test_probe_trust_layer_stale_healthz(monkeypatch) -> None:
    ...
    monkeypatch.setattr(
        "dealix.commercial_ops.selfhost_production.probe_get", fake_probe_get
    )
